...
class MyScene extends THREE.Scene {
  constructor (myCanvas) {
    ...
    //Creamos unos ejes para los modelos
    ...
    //Creamos los modelos
    this.model = new MyBox(this.gui, "Controles de la Caja", this.material);
    this.cono = new MyCone(this.gui, "Controles del Cono", this.material);
    this.cilindro = new MyCylinder(this.gui, "Controles del Cilindro", this.material);
    this.esfera = new MySphere(this.gui, "Controles de la Esfera", this.material);
    this.toro = new MyTorus(this.gui, "Controles del Toro", this.material);
    this.icosaedro = new MyIcosahedron(this.gui, "Controles del Icosaedro", this.material);
