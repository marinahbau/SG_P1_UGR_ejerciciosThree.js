...
class MyScene extends THREE.Scene {
  constructor (myCanvas) {
    ...
    //Creamos un material comun para todos los objetos
    this.material = new THREE.MeshNormalMaterial();
    this.material.side = THREE.DoubleSide;
    
    //Definimos los puntos para el perfil del peon
    this.points = [];
    ...
    //Creamos el peon
    this.peon = new MyObjRevolucion(this.gui, "Parametros 1",this.points, this.material);
    
    this.peon.position.set(0,2,0);

    //Creamos segundo peon
    this.ejesotropeon = new THREE.AxesHelper();

    this.otropeon = new MyObjRevolucion(this.gui, "Parametros 2", this.points, this.material);
  ...
  createGUI () {
    ...
    folder2.add (this.guiControls, 'reset').name ('[ Reset ]').listen();

    folder2.add (this.guiControls, 'resolucion', 3.0, 15.0, 1).name ('Resolucion : ').listen().onChange(function (value) {
    ...
    folder2.add (this.guiControls, 'angulo', 0.0, 2*Math.PI, 0.1).name ('Angulo : ').listen().onChange(function (value) {
